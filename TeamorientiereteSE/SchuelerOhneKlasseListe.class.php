...
class SchuelerOhneKlasseListe {

	private $schueler;
        private $jahrgangsstufe;
        
        
	public function __construct($jahrgangsstufe) {
		$this->schueler = array();
		
		$statement = new DBStatement(DBConnection::getInstance());
                
		$statement->executeQuery("SELECT KindID FROM kind WHERE KlasseID is null and Jahrgangsstufe = '$jahrgangsstufe' order by KindID ASC;");
