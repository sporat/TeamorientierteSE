    ...
    class  Menu {
        ...
        public function __toString() {
            ...
            if (User::getInstance()->getRole() == "Systemadministrator") {			
                ...
                $menu .= "				<ul>";
                $menu .= "					<li><a href='index.php?contentId=eltern_aendern'>Eltern &auml;ndern</a></li>";
                $menu .= "					<li><a href='index.php?contentId=eltern_loeschen'>Eltern l&ouml;schen</a></li>";
                ...
                $menu .= "				<ul>";
                $menu .= "					<li><a href='index.php?contentId=lehrer_anlegen'>Lehrer anlegen</a></li>";
                $menu .= "					<li><a href='index.php?contentId=lehrer_aendern'>Lehrer &auml;ndern</a></li>";
                $menu .= "					<li><a href='index.php?contentId=lehrer_loeschen'>Lehrer l&ouml;schen</a></li>";
                ...
                $menu .= "                                          <li><a href='index.php?contentId=klassenlehrermarkierung_l&ouml;schen'>Klassenlehrermarkierung l&ouml;schen </a></li>";
                $menu .= "                                      </ul>";
                $menu .= "				</ul>";
                $menu .= "                              <ul>";               
                ...
                $menu .= "				<ul>";
                $menu .= "					<li><a href='index.php?contentId=schueler_anlegen_eltern_liste'>Sch&uuml;ler anlegen</a></li>";
                ...
                $menu .= "					<li><a href='index.php?contentId=faecher_aendern'>F&auml;cher &auml;ndern</a></li>";
                $menu .= "				</ul>";    
